package com.zplus.BankAuction.configuration;
...
//        final String password ="auctionbanks@123";
        final String userName = "info@auctionbanks.com";
        final String password = " Info@123";
        String fromEmail = "info@auctionbanks.com";
        ...
        properties.put("mail.smtp.starttls.enable", "true");
        properties.put("mail.smtp.host", "webmail.auctionbanks.com");
